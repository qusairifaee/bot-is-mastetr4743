...
client.on('ready', () => {
  ...
  client.user.setGame(`قريبا أضافه كود ميوزك`,"http://twitch.tv/sfa7")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.channels.find('id', '471650614233923595').setName("W");
client.channels.find('id', '471650614233923595').setName("We");
client.channels.find('id', '471650614233923595').setName("Wel");
client.channels.find('id', '471650614233923595').setName("Welc");
client.channels.find('id', '471650614233923595').setName("Welco");
client.channels.find('id', '471650614233923595').setName("Welcom");
client.channels.find('id', '471650614233923595').setName("Welcome");
client.channels.find('id', '471650614233923595').setName("Welcome T");
client.channels.find('id', '471650614233923595').setName("Welcome To");
client.channels.find('id', '471650614233923595').setName("Welcome To D");
client.channels.find('id', '471650614233923595').setName("Welcome To DM");
